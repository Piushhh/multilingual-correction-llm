...
- **Tokenizer:** SentencePiece BPE tokenizer (`src/core_llm/tokenizer/tokenizer.model`, vocab size 256).
- **Core modules:** model files, SentencePiece tokenizer wrapper, dataset loader, `pretrain.py`, `domain_adapt.py`, `correction_finetune.py`, `train_utils.py`, `generate.py`, `correct.py`, and `CustomLLMAdapter`.
...
- Complete pretraining & domain adaptation once full multilingual corpus is provided.
- Update `docs/team-ownership.md` documentation if needed.
