...
def detect_changes(original: str, corrected: str) -> List[Dict[str, Any]]:
    ...
    Note: This is a deterministic text-diff system and has limitations in perfectly
    identifying linguistic error categories.
    """
    changes = []
    
    # Tokenize by splitting on whitespace for word-level diff, 
    # but keeping spaces to reconstruct
    # A simple approach for this baseline: word level diff
    ...
    for tag, i1, i2, j1, j2 in matcher.get_opcodes():
        ...
        changes.append({
            ...
            "confidence": 1.0  # Deterministic string diff
        })
